...
[LANG_EN] = {
    ...
    [STR_ED_TEST]         = "TEST",
    [STR_ED_WORLD]        = "WORLD",
    [STR_ED_ERASER]       = "ERASER",
    [STR_ED_UNDO]         = "UNDO",
    [STR_ED_CLEAR]        = "CLEAR",
    [STR_ED_RESET]        = "RESET",
    [STR_ED_MENU]         = "MENU",
    [STR_ED_LEVEL]        = "LEVEL",
    [STR_ED_EDITED]       = "edited",
    [STR_ED_SHIPPED]      = "original",
    [STR_ED_NEW_SLOT]     = "new level",
    [STR_ED_HELP_DRAW]    = "L-click: draw",
    [STR_ED_HELP_ERASE]   = "R-click: erase",
    [STR_ED_HELP_TEST]    = "Tab: play it",
    [STR_ED_HELP_DROP]    = "Drop a .lv0/.lvl",
    [STR_ED_TEST_HINT]    = "TAB: EDITOR",
    [STR_ED_PAUSE_HINT]   = "E: EDIT LEVEL",
    [STR_OPT_ED_CLEARED]  = "  level cleared!  ",
    [STR_OPT_ED_IMPORTED] = "     imported     ",
    [STR_OPT_ED_REFUSED]  = "  file refused    ",
    [STR_OPT_ED_RESTORED] = "  original level  ",
    [STR_OPT_ED_SAVE_FAILED] = "   save failed    ",
    [STR_OPT_ED_SAVED]    = "      saved       ",
...
[LANG_FR] = {
    ...
    [STR_ED_UNDO]         = "ANNULER",
    [STR_ED_CLEAR]        = "VIDER",
    [STR_ED_RESET]        = "ORIGINE",
    [STR_ED_MENU]         = "MENU",
    [STR_ED_LEVEL]        = "NIVEAU",
    [STR_ED_EDITED]       = "modifie",
    [STR_ED_SHIPPED]      = "d'origine",
    [STR_ED_NEW_SLOT]     = "nouveau niveau",
    [STR_ED_HELP_DRAW]    = "Clic G : poser",
    [STR_ED_HELP_ERASE]   = "Clic D : effacer",
    [STR_ED_HELP_TEST]    = "Tab : y jouer",
    [STR_ED_HELP_DROP]    = "Deposer .lv0/.lvl",
    [STR_ED_TEST_HINT]    = "TAB : EDITEUR",
    [STR_ED_PAUSE_HINT]   = "E : EDITER",
    [STR_OPT_ED_CLEARED]  = " niveau termine ! ",
    [STR_OPT_ED_IMPORTED] = "      importe     ",
    [STR_OPT_ED_REFUSED]  = "  fichier refuse  ",
    [STR_OPT_ED_RESTORED] = " niveau d origine ",
    [STR_OPT_ED_SAVE_FAILED] = " echec sauvegarde ",
    [STR_OPT_ED_SAVED]    = "    sauvegarde    ",
